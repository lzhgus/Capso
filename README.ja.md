...
Capso は macOS コミュニティへの還元であり、Swift 6 ベースのモダンでモジュール化されたアプリの実例でもあります。
...
- **Quick Access** — コピー・保存・注釈・OCR・ピン留めに加え、保存せずに新しいスクリーンショットを他のアプリへ送れる専用ドラッグハンドル付きのフローティングプレビュー
...
- **クリップボードへ自動コピー** — 完了した録画を MP4 または GIF ファイルとして書き出し、すぐにペースト可能
